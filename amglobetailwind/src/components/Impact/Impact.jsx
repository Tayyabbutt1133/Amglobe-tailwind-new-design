...
const Impact = () => {
  return (
      <>
      <div name="impactMain" className='md:mt-40 mt-64'>
        ...
        <div className="impact-container-one flex flex-col justify-center items-center gap-6">
          <h2 className=' text-white sm:text-3xl font-bold 2xl:text-4xl text-2xl'>Our Impact in Numbers</h2>
        ...
        <div name="impact-container-two" className="border-2 border-gray-600 bg-[#191919] md:w-[80%] w-[85%] mx-auto  mt-10 p-8 grid md:grid-cols-4 gap-10  rounded-md  2xl:gap-72  xs:grid-cols-2 grid-cols-1 text-center" >
