    ...
    <>
      <div name="industriesMain" className="mt-64 relative">
        <div
          ...
          className="text-white bg-[#4158E8] p-6 2xl:p-16 w-[100%] "
        >
          <h1 className="sm:text-2xl font-bold xs:text-xl 2xl:text-5xl flex md:justify-end xl:mx-36 lg:mx-20 md:text-xl lg:text-2xl justify-center">
            INDUSTRIES THAT WE ARE SERVING
          </h1>
          <div className="rightcontainer-list mt-5 grid lg:grid-cols-3 xs:grid-cols-2">
            <div className="Inner-list hover:bg-white hover:text-[#4158E8]">Automation</div>
            <div className="Inner-list hover:bg-white hover:text-[#0c0d0f]">Automation</div>
            <div className="Inner-list hover:bg-white hover:text-[#4158E8]">Automation</div>
            <div className="Inner-list hover:bg-white hover:text-[#4158E8]">Automation</div>
            <div className="Inner-list hover:bg-white hover:text-[#4158E8]">Automation</div>
            <div className="Inner-list hover:bg-white hover:text-[#4158E8]">Automation</div>
            <div className="Inner-list hover:bg-white hover:text-[#4158E8]">Aviation</div>
            <div className="Inner-list hover:bg-white hover:text-[#4158E8]">Aviation</div>
            <div className="Inner-list hover:bg-white hover:text-[#4158E8]">Aviation</div>
            <div className="Inner-list hover:bg-white hover:text-[#4158E8]">Aviation</div>
            <div className="Inner-list hover:bg-white hover:text-[#4158E8]">Aviation</div>
