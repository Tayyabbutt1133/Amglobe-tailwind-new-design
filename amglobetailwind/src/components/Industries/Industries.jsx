      ...
      <>
        <div name="industriesMain" className=' mt-64'>
          <div className="industriesContainer relative ">
              ...
              <div name="rightcontainer-box" className=' text-white bg-[#4158E8] lg:w-[50%] sm:absolute lg:top-36 top-2 p-10 sm:right-20 2xl:left-[40em] 2xl:p-16 xs:w-[80%] xs:mx-auto mx-4'>
